...
all_data <- readRDS("~/Desktop/late_feb_runs/datasets/glabrata_sudeste.rds")
maxent_function(all_data, NA, "~/Desktop/late_feb_runs/glabrata_mg_models/", 10, 0.8, FALSE, FALSE)
