...
occurrences <- readRDS("~/Desktop/national_occurrences_thinned_mapping.rds")
...
occurrences <- readRDS("~/Desktop/sp_occurrences_thinned_mapping.rds")
...
occurrences <- readRDS("~/Desktop/mg_occurrences_thinned_mapping.rds")
occurrences$species <- factor(occurrences$species, levels=c("B. glabrata", "B. straminea", "B. tenagophila"))
occurrences <- occurrences[order(occurrences$species,decreasing=F),]
